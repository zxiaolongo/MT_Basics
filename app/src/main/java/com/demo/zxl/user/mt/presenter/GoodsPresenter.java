...
import com.demo.zxl.user.mt.model.bean.BusinessInfo;
import com.demo.zxl.user.mt.model.bean.GoodsInfo;
import com.demo.zxl.user.mt.model.bean.GoodsTypeInfo;
import com.demo.zxl.user.mt.model.bean.ResponseInfo;
